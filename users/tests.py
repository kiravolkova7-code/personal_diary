...
class UserFactory:
    @staticmethod
    def create(**kwargs):
        defaults = {"email": "factory@example.com", "password": "factorypass123"}
...
class RegistrationFormTest(TestCase):
    ...
    def test_duplicate_email_in_form(self):
        ...
        form = RegistrationForm(data={"email": "dup@test.ru", "password1": "pass1", "password2": "pass1"})
...
class AuthViewsTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="loggedin@example.com", password="logpass")
