...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'email': forms.EmailInput(attrs={'placeholder': 'Email*', 'aria-label': 'Электронная почта', 'class': 'form-control'}),
            'phone': forms.TextInput(attrs={'placeholder': 'Телефон (+7 999 999 99 99)', 'aria-label': 'Телефон', 'class': 'form-control', 'type': 'tel'}),
