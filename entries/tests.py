...
class EntryFactory:
    ...
    def create(**kwargs):
        ...
        defaults = {"title": "Тестовая запись", "content": "Содержимое записи.", "subject": "personal", "user": user}
        defaults.update(kwargs)
...
class EntryWebViewsTest(TestCase):
    ...
    def test_create_entry_via_web_form(self):
        ...
        # Теперь POST
        post_data = {"title": "Запись через сайт", "subject": "work", "content": "Текст из браузера"}
